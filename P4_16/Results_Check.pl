...
my $BW_FV_SRAM = 16;
my $FV_size = 8;
my $Num_FV_line = $BW_FV_SRAM / $FV_size;      # 16/8=2
my $Num_FV = 16;
my $offset_FV_Node = $Num_FV / $Num_FV_line;    # 16/2=8 lines per node
my $line_cnt = 0;
my $num_nodes = 32;
...
my $Num_Output_line = $Num_Weight_Layer / $Num_FV_line;    # 2/2=1
my $output_cnt = 0;
my $Current_Node = 1;
